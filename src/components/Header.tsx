...
const Header = ({ links = headerLinks }: { links?: HeaderLink[] }) => {
  return (
    <header className="flex gap-2 sm:gap-4 items-center w-full justify-between border-b border-gray-200 dark:border-gray-800 py-3 sm:py-4 px-4 sm:px-8 md:px-12">
